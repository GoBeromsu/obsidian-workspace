...
- Favor existing patterns in `docs/patterns.md`, `src/shared/`, and neighboring files.
- Follow mandatory code rules in `docs/rules.md` — SRP, 200 LOC limit, no catch-all files. Violations block work.
